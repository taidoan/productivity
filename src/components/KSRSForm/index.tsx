    ...
    <div className={``}>
      ...
      <div className={`flex flex-col gap-4 flex-wrap w-full md:flex-row md:col-span-4 `}>
          ...
          <div className={`${formFieldClass} !flex-row gap-x-3 md:justify-center`}>
            <label htmlFor="kitchenLates" className={`${labelClass}`}>Kitchen Lates: <span className="text-sm font-normal text-grey-400">(Optional)</span></label>
            <input 
              type="checkbox"
              id="kitchenLates"
              checked={kitLates} 
          ...
          <div className={`${formFieldClass} !flex-row gap-x-3 md:justify-center`}>
            <label htmlFor="floorLates" className={`${labelClass}`}>Floor Lates: <span className="text-sm font-normal text-grey-400">(Optional)</span></label>
            <input 
              type="checkbox"
              id="floorLates"
              checked={floorLates} 
