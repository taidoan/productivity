  ...
  return (
    <div className={``}>
      ...
      <form onSubmit={handleSubmit} className={`flex flex-wrap gap-4 md:grid grid-cols-4`}>
        ...
        <div className={`flex flex-col gap-4 flex-wrap w-full md:flex-row md:col-span-4 `}>
          <div className={`${formFieldClass} !flex-row gap-x-3 md:justify-center`}>
            <label htmlFor='kitchenLates' className={`${labelClass}`}>
              Kitchen Lates: <span className='text-sm font-normal text-grey-400'>(Optional)</span>
            </label>
            <input
              type='checkbox'
              id='kitchenLates'
          ...
          <div className={`${formFieldClass} !flex-row gap-x-3 md:justify-center`}>
            <label htmlFor='floorLates' className={`${labelClass}`}>
              Floor Lates: <span className='text-sm font-normal text-grey-400'>(Optional)</span>
            </label>
            <input
              type='checkbox'
              id='floorLates'
          ...
          <div className={`${formFieldClass} !flex-row gap-x-3 md:justify-center`}>
            <label htmlFor='foodLift' className={`${labelClass}`}>
              Food Lift: <span className='text-sm font-normal text-grey-400'>(Optional)</span>
            </label>
            <input
              type='checkbox'
              id='foodLift'
        ...
        <div className={`${formFieldClass} col-span-4`}>
          <label htmlFor='serviceSummaryData' className={`${labelClass}`}>
        ...
        <div className={`${formFieldClass} col-span-4`}>
          <label htmlFor='prodData' className={`${labelClass}`}>
            Productivity Data:{' '}
            <span className='text-sm font-normal text-grey-400'>
              (Required<span className='text-red-600'>*</span>)
            </span>
