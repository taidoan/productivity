...
export const hitTargetColour = '!bg-lime-500 dark:!bg-lime-800 print:dark:!bg-lime-500 print:!bg-lime-500'
export const overTargetColour = '!bg-amber-400 dark:!bg-amber-600 print:dark:!bg-amber-400 print:!bg-amber-400'
export const failedTargetColour = '!bg-red-500 dark:!bg-red-600 print:dark:!bg-red-500 print:!bg-red-500'

export const hitTargetKey = (<span className={`${hitTargetColour} inline-block w-3 h-3 mr-2`}></span>);
export const overTargetKey = (<span className={`${overTargetColour} inline-block w-3 h-3 mr-2`}></span>)
export const failedTargetKey = (<span className={`${failedTargetColour} inline-block w-3 h-3 mr-2`}></span>)
